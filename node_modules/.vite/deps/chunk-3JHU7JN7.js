...
} from "./chunk-HHA7H23U.js";
import {
  require_scheduler,
  require_tracing
} from "./chunk-J32NRMSD.js";
import {
  require_object_assign,
  require_react
} from "./chunk-RL4N37YU.js";
import {
  __commonJS,
  __toESM
      ...
      module.exports = function $$$reconciler($$$hostConfig) {
        ...
        function shallowEqual(objA, objB) {
          ...
          for (var i2 = 0; i2 < keysA.length; i2++) {
            if (!hasOwnProperty.call(objB, keysA[i2]) || !objectIs(objA[keysA[i2]], objB[keysA[i2]])) {
              return false;
            }
          }
          return true;
        ...
        function readContext(context2, observedBits) {
          ...
          return isPrimaryRenderer ? context2._currentValue : context2._currentValue2;
        }
        var UpdateState = 0;
        var ReplaceState = 1;
        var ForceUpdate = 2;
        ...
        function mountOpaqueIdentifier() {
          var makeId2 = makeClientIdInDEV.bind(null, warnOnOpaqueIdentifierAccessInDEV.bind(null, currentlyRenderingFiber$1));
          if (getIsHydrating()) {
        ...
        function flushPendingDiscreteUpdates() {
          if (rootsWithPendingDiscreteUpdates !== null) {
            var roots2 = rootsWithPendingDiscreteUpdates;
            rootsWithPendingDiscreteUpdates = null;
            roots2.forEach(function(root) {
...
function createRenderer(roots2) {
  ...
  function applyProps2(instance, data) {
  ...
  function createInstance(type, {
    ...
    if (type === "primitive") {
      ...
      const target = catalogue[name] || three_module_exports[name];
      if (!target)
...
var createStore2 = (applyProps2, invalidate2, advance2, props) => {
  const {
    gl,
    size,
    shadows = false,
  ...
  const rootState = create((set, get) => {
    ...
    function getCurrentViewport(camera2 = get().camera, target = defaultTarget, size2 = get().size) {
      const {
        width,
        height
      } = size2;
      ...
      const distance = camera2.getWorldPosition(position).distanceTo(tempTarget);
  ...
  rootState.subscribe(() => {
    ...
    if (!(internal.lastProps.camera instanceof Camera)) {
  ...
  }, (state2) => [state2.viewport.dpr, state2.size], shallow);
...
function createLoop(roots2) {
  ...
  function invalidate2(state) {
    if (!state)
      return roots2.forEach((root) => invalidate2(root.store.getState()));
...
var Canvas = React.forwardRef(function Canvas2({
  children,
  fallback,
  tabIndex,
  resize,
...
useLoader.clear = function(Proto, input) {
  const keys2 = Array.isArray(input) ? input : [input];
  return useAsset.clear(Proto, ...keys2);
};
...
function render(element, canvas, {
  ...
  if (fiber && state) {
    if (props.dpr !== void 0 && !is.equ(state.viewport.dpr, calculateDpr(props.dpr)))
  ...
  if (!fiber) {
    ...
    store = createStore2(applyProps, invalidate, advance, {
      gl: glRenderer,
      size,
      ...props
    });
...
react-reconciler/cjs/react-reconciler.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-3JHU7JN7.js.map
